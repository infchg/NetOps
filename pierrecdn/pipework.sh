#!/bin/bash
############## THIS PIPEWORK WAS FOUND ON INTERNET #######
######## as a way to plug containers easily to bridges
########
######## GIT source & Author :  https://github.com/pierrecdn/pipework
######## cited by :  http://blog.iss.ms/2014/04/14/185702 
######## my Changes:
######## eth1 to be changed to add flexibility !!  Martinez J Carlos 2015/12/30
...
[ "$IPADDR" ] || {
    echo "Syntax:"
    echo "pipework <hostinterface> <guest> <ipaddr>/<subnet> <broadcast> <gateway> [macaddr]"
    echo "pipework <hostinterface> <guest> dhcp <broadcast> <gateway> [macaddr]"
    echo "pipework --wait"
    exit 1
}
...
################ this eth1 is to be changed:  Martinez J Carlos 2015/12/30 for more flexibility !!
